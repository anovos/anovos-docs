...
## Functions
<dl>
<dt id="anovos.data_ingest.ts_auto_detection.regex_date_time_parser"><code class="name flex hljs csharp">
...
<dd>Custom data type basis which further processing will be conditioned.</dd>
<dt><strong><code>save_output</code></strong></dt>
<dd>Output path where the transformed ddata can be saved</dd>
...
<dt id="anovos.data_ingest.ts_auto_detection.ts_loop_cols_pre"><code class="name flex hljs csharp">
...
<dd>Output path where the data would be saved</dd>
