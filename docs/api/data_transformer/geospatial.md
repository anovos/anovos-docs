...
<dd>
<div class="desc"><p>Calculate centroid of a given DataFrame
Parameters</p>
<hr>
<dl>
...
<dd>
<div class="desc"><p>Convert locations from cartesian format to other formats.</p>
...
<dd>
<div class="desc"><p>Convert locations from geohash format to other formats.</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe.</dd>
...
<dd>
<div class="desc"><p>Convert locations from lat, lon format to other formats.</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe.</dd>
...
<dd>
<div class="desc"><p>Control the precision of geohash columns.</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe.</dd>
...
<span class="k">def</span> <span class="nf"><span class="ident">location_distance</span></span>(<span class="n">idf, list_of_cols_loc1, list_of_cols_loc2, loc_format='dd', result_prefix='', distance_type='haversine', unit='m', optional_configs={'radius': 6371009, 'vincenty_model': 'WGS-84'}, output_mode='append')</span>
</code></dt>
<dd>
<div class="desc"><p>Calculate the distance between 2 locations.</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe.</dd>
...
<dt id="anovos.data_transformer.geospatial.location_in_country"><code class="name flex hljs csharp">
<span class="k">def</span> <span class="nf"><span class="ident">location_in_country</span></span>(<span class="n">spark, idf, list_of_lat, list_of_lon, country, country_shapefile_path='', method_type='approx', result_prefix=[], output_mode='append')</span>
</code></dt>
<dd>
<div class="desc"><p>To check whether each lat-lon pair is insided a country. Two ways of checking are supported: "approx" (using the
bounding box of a country) and "exact" (using the shapefile of a country).</p>
<h2 id="parameters">Parameters</h2>
<dl>
...
<dd>The Alpha-2 country code.</dd>
<dt><strong><code>country_shapefile_path</code></strong></dt>
<dd>The geojson file with a FeatureCollection object containing polygons for each country. One example
file country_polygons.geojson can be downloaded from Anovos GitHub repository:
<a href="https://github.com/anovos/anovos/tree/main/data/">https://github.com/anovos/anovos/tree/main/data/</a></dd>
<dt><strong><code>method_type</code></strong></dt>
<dd>"approx", "exact".
"approx" uses the bounding box of a country to estimate whether a location is inside the country
"exact" uses the shapefile of a country to calculate whether a location is inside the country</dd>
<dt><strong><code>result_prefix</code></strong></dt>
<dd>List of prefixes for the newly generated column names.
Alternatively, prefixes can be specified in a string format,
where different prefixes are separated by pipe delimiter "|" e.g., "pf1|pf2".
...
<dt id="anovos.data_transformer.geospatial.location_in_polygon"><code class="name flex hljs csharp">
<span class="k">def</span> <span class="nf"><span class="ident">location_in_polygon</span></span>(<span class="n">idf, list_of_lat, list_of_lon, polygon, result_prefix=[], output_mode='append')</span>
</code></dt>
<dd>
<div class="desc"><p>To check whether each lat-lon pair is insided a GeoJSON object. The following types of GeoJSON objects
are supported by this function: Polygon, MultiPolygon, Feature or FeatureCollection</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe.</dd>
...
<dd>The following types of GeoJSON objects are supported: Polygon, MultiPolygon, Feature or FeatureCollection</dd>
<dt><strong><code>result_prefix</code></strong></dt>
<dd>List of prefixes for the newly generated column names.
Alternatively, prefixes can be specified in a string format,
where different prefixes are separated by pipe delimiter "|" e.g., "pf1|pf2".
...
<dt id="anovos.data_transformer.geospatial.reverse_geocoding"><code class="name flex hljs csharp">
<span class="k">def</span> <span class="nf"><span class="ident">reverse_geocoding</span></span>(<span class="n">idf, lat_col, long_col)</span>
</code></dt>
<dd>
<div class="desc"><p>Reverse the input latitude and longitude of a given DataFrame into address
Parameters</p>
<hr>
<dl>
<dt><strong><code>idf</code></strong></dt>
...
<dl>
<dt><strong><code>odf</code></strong> :&ensp;<code>DataFrame</code></dt>
<dd>Output DataFrame, which contains latitude, longitude and address appropriately</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dt id="anovos.data_transformer.geospatial.rog_calculation"><code class="name flex hljs csharp">
<span class="k">def</span> <span class="nf"><span class="ident">rog_calculation</span></span>(<span class="n">idf, lat_col, long_col, id_col=None)</span>
</code></dt>
<dd>
<div class="desc"><p>Calculate Radius of Gyration (in meter) of a given DataFrame, based on its identifier column (if applicable)
Parameters</p>
<hr>
<dl>
<dt><strong><code>idf</code></strong></dt>
...
<dd>Column in the input DataFrame that contains longitude data</dd>
<dt><strong><code>id_col</code></strong></dt>
<dd>Column in the input DataFrame that contains identifier for the DataFrame (Default is None)</dd>
</dl>
<h2 id="returns">Returns</h2>
<dl>
<dt><strong><code>odf</code></strong> :&ensp;<code>DataFrame</code></dt>
<dd>Output DataFrame, which contains Radius of Gyration (in meter) and identifier (if applicable)</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dt id="anovos.data_transformer.geospatial.weighted_centroid"><code class="name flex hljs csharp">
<span class="k">def</span> <span class="nf"><span class="ident">weighted_centroid</span></span>(<span class="n">idf, id_col, lat_col, long_col)</span>
</code></dt>
<dd>
<div class="desc"><p>Calculate weighted centroid of a given DataFrame, based on its identifier column
Parameters</p>
<hr>
<dl>
<dt><strong><code>idf</code></strong></dt>
...
<dd>Column in the input DataFrame that contains longitude data</dd>
<dt><strong><code>id_col</code></strong></dt>
<dd>Column in the input DataFrame that contains identifier for the DataFrame</dd>
</dl>
<h2 id="returns">Returns</h2>
<dl>
<dt><strong><code>odf</code></strong> :&ensp;<code>DataFrame</code></dt>
<dd>Output DataFrame, which contains weighted lat_centroid and long_centroid and identifier</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
