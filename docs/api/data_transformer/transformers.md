...
def expression_parser(idf, list_of_expr, postfix="", print_impact=False):
    ...
    -------
    type
        Output Dataframe appended with expression-derived attributes
...
<dl>
<dt><code>type</code></dt>
<dd>Dataframe with encoded columns.</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dl>
<dt><code>type</code></dt>
<dd>Output Dataframe appended with expression-derived attributes</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dl>
<dt><code>type</code></dt>
<dd>Dataframe after outlier treatment</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
