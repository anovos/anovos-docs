...
<dd>function name for which argument needs to be check</dd>
<dt><strong><code>args</code></strong></dt>
<dd>arguments to check in dictionary format</dd>
</dl>
<h2 id="returns">Returns</h2>
<dl>
<dt><code>List</code></dt>
<dd>list of columns to analyze</dd>
</dl></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dd>
<div class="desc"><p>Extract the last day of the month of given timestamp/date columns.</p>
<h2 id="parameters">Parameters</h2>
<dl>
<dt><strong><code>idf</code></strong></dt>
<dd>Input Dataframe</dd>
...
<dd>Number of row(s) to extend.</dd>
...
“append” option appends derived column to the input dataset, e.g. given output_type="ts_diff",
lag=5, tsdiff_unit="days", column X is appended as X_X_lag5_daydiff. (Default value = "append")</dd>
</dl>
<h2 id="returns">Returns</h2>
<dl>
<dt><code>DataFrame</code></dt>
...
<dd>First column to calculate the difference</dd>
<dt><strong><code>ts2</code></strong></dt>
<dd>Second column to calculate the difference.</dd>
<dt><strong><code>unit</code></strong></dt>
<dd>"second", "minute", "hour", "day", "week", "month", "year".
...
by default, or rolling type) ordered by the given timestamp column and partitioned by partition_col ("" by
default, to indicate no partition).</p>
